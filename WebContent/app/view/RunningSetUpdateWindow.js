//var selectedTreeStore = Ext.create('Ext.data.TreeStore', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
	        ...
	        },
	    	{
	    		...
	    		title:'选择测试',
	    		flex: 30,
	    		store: Ext.getStore('SelectedTreeStore'),
	    		useArrows:true,
	    		autoScroll:true,
	    		animate:true,
	    		enableDD:true,
	    	...
	    	},
	    	{
                ...
                handler: function(button, event) {
                	...
                	for(var i=0;i<arr.length;i++){
                		...
                		if(Ext.String.endsWith(path,'-leaf'))
	    	...
	    	listeners: {
				show: {
                    fn: function(window, eOpts){
                    	Ext.getCmp('RunningSetUpdatedName').setValue(Ext.getCmp('Base').folderName.split('@')[0]);
                    },
                    scope: me
                }
			}
