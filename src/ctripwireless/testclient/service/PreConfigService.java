...
import ctripwireless.testclient.httpmodel.QueryBoundDataItem;
import ctripwireless.testclient.httpmodel.ServiceBoundDataItem;
import ctripwireless.testclient.httpmodel.TestConfigItem;
...
import ctripwireless.testclient.model.QueryBoundDataItemContainer;
import ctripwireless.testclient.model.ServiceBoundDataItemContainer;
...
public class PreConfigService {
	...
	private void addLabel2TypeInParameterObject(String testPath,List<String> parastrs){
		try {
			...
			Map<String,Parameter> p=target.getParameters();
